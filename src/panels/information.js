			...
			<div style={{
				...
				<div style={{marginBottom: '10px', textAlign: "justify"}}>
					<div>
						...
						ошибках, предлагать улучшения и делиться вашим опытом. С вашей помощью мы сможем сделать наше
				...
				<div style={{textAlign: "justify"}}>
					<div>
						<Link href='https://hmtpk.ru/' target="_blank">
							Официальный сайт Ханты-Мансийского технолого-педагогического колледжа <Icon24ExternalLinkOutline width={16} height={16}/>
