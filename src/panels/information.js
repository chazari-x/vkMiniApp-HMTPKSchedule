			...
			<Card mode="outline-tint" style={{
				...
				<div style={{marginBottom: '10px', textAlign: "justify"}}>
					<Paragraph>
						...
						колледжа.
						Вы также можете проверить расписание, нажав на кнопку "Проверить расписание на сайте",
						которая расположена под расписанием.
					</Paragraph>
				</div>
				<div style={{marginBottom: '10px', textAlign: "justify"}}>
					<Paragraph>
				...
				<div style={{marginBottom: '10px', textAlign: "justify"}}>
					<div>
						<Link href={config.group.href} target="_blank">
							Разработчики: {config.group.name} <Icon24ExternalLinkOutline width={16} height={16}/>
						</Link> стремятся обеспечить максимальную точность информации,
						но в случае обнаружения ошибок или неточностей, они готовы к оперативной их коррекции.
						...
						наше
						приложение ещё лучше!
					</div>
				</div>
				<div style={{textAlign: "justify"}}>
					<div>
						<Link href='https://hmtpk.ru/' target="_blank">
							Официальный сайт Ханты-Мансийского технолого-педагогического
							колледжа <Icon24ExternalLinkOutline width={16} height={16}/>
